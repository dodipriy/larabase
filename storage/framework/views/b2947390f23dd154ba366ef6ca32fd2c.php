            ...
            <div class="card-body">
                <ul class="p-0 m-0">
                    <li class="d-flex align-items-center mb-4">
                        <img src="<?php echo e(asset('vuexy/assets/svg/flags/us.svg')); ?>" alt="User" class="rounded-circle me-3" width="34" />
                    ...
                    <li class="d-flex align-items-center mb-4">
                        <img src="<?php echo e(asset('vuexy/assets/svg/flags/br.svg')); ?>" alt="User" class="rounded-circle me-3" width="34" />
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                                <div class="d-flex align-items-center">
                    ...
                    <li class="d-flex align-items-center mb-4">
                        <img src="<?php echo e(asset('vuexy/assets/svg/flags/in.svg')); ?>" alt="User" class="rounded-circle me-3" width="34" />
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                                <div class="d-flex align-items-center">
                    ...
                    <li class="d-flex align-items-center mb-4">
                        <img src="<?php echo e(asset('vuexy/assets/svg/flags/au.svg')); ?>" alt="User" class="rounded-circle me-3" width="34" />
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                                <div class="d-flex align-items-center">
                    ...
                    <li class="d-flex align-items-center mb-4">
                        <img src="<?php echo e(asset('vuexy/assets/svg/flags/fr.svg')); ?>" alt="User" class="rounded-circle me-3" width="34" />
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                                <div class="d-flex align-items-center">
                    ...
                    <li class="d-flex align-items-center">
                        <img src="<?php echo e(asset('vuexy/assets/svg/flags/cn.svg')); ?>" alt="User" class="rounded-circle me-3" width="34" />
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                                <div class="d-flex align-items-center">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dodi/Project/GITHUB/larabase/resources/views/admin/contents/index.blade.php ENDPATH**/ ?>