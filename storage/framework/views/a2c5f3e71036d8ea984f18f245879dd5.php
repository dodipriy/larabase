...
<!-- <div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title"><?php echo e($menu['breadcrumbs']->name); ?> Table</h4>
...
<?php echo $__env->make('admin.contents.user._modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    var url = {
        detail: "<?php echo e(route('dashboard_user_detail')); ?>",
        delete: "<?php echo e(route('dashboard_user_delete')); ?>",
        submit: "<?php echo e(route('dashboard_user_post')); ?>",
        table: "<?php echo e(route('dashboard_user_table')); ?>"
    };
    var table;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dodi/Project/larabasev2/resources/views/admin/contents/user/index.blade.php ENDPATH**/ ?>